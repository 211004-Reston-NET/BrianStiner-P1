...
//                 Store teststore = new Store() { Id = 10000};
//                 teststore = _repo.Get(teststore);
...
//                 Customer testcustomer = new Customer { Id = 10000 };
//                 testcustomer = _repo.Get(testcustomer);
...
//                 Order testorder = new Order { Id = 11101 };
//                 testorder = _repo.Get(testorder);
...
//                 LineItem testlineitem = new LineItem { Id = 11101 };
//                 testlineitem = _repo.Get(testlineitem);
...
//                 Product testproduct = new Product { Id = 10001 };
//                 testproduct = _repo.Get(testproduct);
//                 //Assert
